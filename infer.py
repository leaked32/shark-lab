...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate text from a shark-lab model checkpoint.")
    ...
    tokenizer, eos_token_id = shark.format.get_tokenizer(opt.general.tokenizer_path)
